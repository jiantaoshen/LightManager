    ...
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-border bg-sidebar md:flex md:flex-col">
        ...
        <div className="border-t border-border p-3">
          {isTrial ? (
            <div className="mb-2 rounded-lg bg-muted px-3 py-3">
              ...
              <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
                Changes in trial mode are stored only in
                this browser and do not modify the demo
                account.
              </p>
            </div>
          ) : (
            <NavLink
              to="/profile"
              className="mb-2 block rounded-lg px-3 py-2 hover:bg-accent/60"
            >
              <p className="truncate text-sm font-medium">
